...
export class HomePageComponent {
  ...
  Over the years, I have honed my skills in HTML, CSS, JavaScript, and TypeScript. I have a solid experience with frameworks such as Angular and React, and I'm also familiar with Bootstrap for user interface design. In addition, I have experience with CSS preprocessors like Sass.
